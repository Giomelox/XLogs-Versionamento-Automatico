from app.funções.funções_IOB import emitir_NF_dev_dell, emitir_NF_dev_hp, emitir_NF_dev_flex
from app.funções.funções_elogistic import valores_devolução_DELL, valores_devolução_HP
