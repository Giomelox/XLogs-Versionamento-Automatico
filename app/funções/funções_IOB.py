from app.funções.funções_conectar_email import aux_path_XML_destino, conectar_email_e_baixar_arquivos_Dell, conectar_email_e_baixar_arquivos_HP
from app.funções.funções_Gerais import obter_configs, PlanilhaManager, navigate
