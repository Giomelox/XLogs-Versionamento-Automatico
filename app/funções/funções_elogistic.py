from app.funções.funções_conectar_email import aux_path_XML_destino, download_dir, conectar_email_e_baixar_arquivos_HP, conectar_email_e_baixar_arquivos_Dell
